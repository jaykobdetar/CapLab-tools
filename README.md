...
- **focus_patch.py** linux only tool, patches a byte of memory in the running game so that it doesn't pause upon losing focus, allowing the game to run in the background. 
## Libraries
